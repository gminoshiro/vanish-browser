...
**日本語**:
```
90日間未起動で自動削除。デジタル遺品を残さない、完全プライバシー保護ブラウザ。
```

**英語**:
```
Auto-delete after 90 days unused. Privacy-first browser with no digital legacy.
```
...
**Vanish Browser**は、そんな「万が一」に備える、新しいプライバシーブラウザです。

---

## 🎯 唯一の「長期放置時自動削除」ブラウザ

他のプライバシーブラウザは「終了時に削除」。
でもVanishは違います。

**90日間未起動で、すべてのデータを自動削除。**

日常使いしながら、万が一のときも安心。
これまでになかった、新しいアプローチです。
...
### 🕒 自動削除機能
90日間アプリを開かなかった場合、全データを自動削除。
突然の事故や病気でも、デジタル遺品を残しません。
